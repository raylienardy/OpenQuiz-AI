...
class ExportPreview(BaseModel):
    ...
    estimated_size_human: Optional[str] = Field(None, description="Ukuran yang dapat dibaca manusia (e.g., 248 KB)")
    ...
    capabilities: Dict[str, Any] = Field(default_factory=dict, description="Kemampuan ekspor (footer, metadata, dll.)")
    download_endpoint: Optional[str] = Field(None, description="Endpoint untuk mengunduh file yang dihasilkan")
